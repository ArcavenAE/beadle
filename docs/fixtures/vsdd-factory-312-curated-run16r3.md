...
|---|---|---|
| PR acceptance | 🟢 **71%** (22/31, zero rejections) | agent/bot population baseline is 37–45%; human band 68–73% — we sit at the human bar, ~2× the agent baseline |
| Engagement cadence | 🟢 **5 attention windows / 3 weeks** | per-window volume rising 3→5→31→2→22 actions — a top-percentile outlier for a lightly maintained project |
| Merge latency | 🟢 **≤ 2 windows** | ready PRs merge within one or two maintainer attention windows |
| Ramp prediction (aae-orc#65) | 🔴 **FAILED** (under v1 — permanent) | ceiling stayed P0b a third window (#623/PR #718); zero P0a/SDL actions; RAMPING qualifier retired |
| Selection depth | ⚠️ **shallow — watch** | 20/20 acted items arrived with a mergeable diff; the SDL lane has none. #342/#365/#358: untouched in **5/5 windows** (7 runs shadow) |
| Next decisive move | **ours** | ship SDL fix PRs — sitting ≥ 2 windows falsifies the cost explanation; merging discharges A4 |
...
run-17 intake.
_Updated 2026-07-22 (r3) · watermark #753 · run 16 · intent vsdd-factory@0.4
...
<details><summary>🤖 agent channel — attn.* facet screens (runs 12–16)</summary>
